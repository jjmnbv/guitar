...
public class MerchantPrPageResponse extends PageResponse implements Serializable {
	...
	public static <E> MerchantPrPageResponse buildPageResponse(MerchantPrPageResponse pageResponse, Page<E> page, int displayPages) {
