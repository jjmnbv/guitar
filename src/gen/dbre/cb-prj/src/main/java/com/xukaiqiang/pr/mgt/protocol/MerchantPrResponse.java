...
public class MerchantPrResponse extends OutputMessage implements Serializable {
	...
	public static <E> MerchantPrResponse buildResponse(MerchantPrResponse response, E e) {
