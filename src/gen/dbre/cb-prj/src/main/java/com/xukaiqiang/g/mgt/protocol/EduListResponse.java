...
public class EduListResponse extends OutputMessage implements Serializable {
	...
	public static <E> EduListResponse buildListResponse(EduListResponse pageResponse, List<E> list) {
		for(E e : list) {
