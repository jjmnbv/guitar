...
public class JobPageResponse extends PageResponse implements Serializable {
	...
	public static <E> JobPageResponse buildPageResponse(JobPageResponse pageResponse, Page<E> page, int displayPages) {
