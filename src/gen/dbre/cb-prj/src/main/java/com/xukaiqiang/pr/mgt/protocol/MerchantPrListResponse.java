...
public class MerchantPrListResponse extends OutputMessage implements Serializable {
	...
	public static <E> MerchantPrListResponse buildListResponse(MerchantPrListResponse pageResponse, List<E> list) {
		for(E e : list) {
