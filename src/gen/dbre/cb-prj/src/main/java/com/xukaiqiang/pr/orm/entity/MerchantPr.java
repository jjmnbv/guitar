package com.xukaiqiang.pr.orm.entity;
...
import com.xukaiqiang.pr.orm.dialect.AbstractMerchantPr;
import com.xukaiqiang.pr.orm.dialect.Schema.Tables;
 ...
 */
@Entity
@Table(name = Tables.MERCHANTPR)
public class MerchantPr extends AbstractMerchantPr implements Serializable {
	private static final long serialVersionUID = 1L;

	@Column(name = Columns.MERCHANTPR_ANNUALTURNOVER)
	private String annualTurnover;
	@Column(name = Columns.MERCHANTPR_AREACODE)
	private String areaCode;
	@Column(name = Columns.MERCHANTPR_ATTENDANCE)
	private String attendance;
	@Column(name = Columns.MERCHANTPR_AVERHOURFEE)
	private String averHourFee;
	@Column(name = Columns.MERCHANTPR_BRANCHNUM)
	private String branchNum;
	@Column(name = Columns.MERCHANTPR_CHURNRATE)
	private String churnRate;
	@Column(name = Columns.MERCHANTPR_COABBNA)
	private String coAbbNa;
	@Column(name = Columns.MERCHANTPR_COASSID)
	private Long coAssId;
	@Column(name = Columns.MERCHANTPR_COATTRCA)
	private String coAttrCa;
	@Column(name = Columns.MERCHANTPR_COATTRCD)
	private String coAttrCd;
	@Column(name = Columns.MERCHANTPR_COBULICNO)
	private String coBuLicNo;
	@Column(name = Columns.MERCHANTPR_COINDKICA)
	private String coIndKiCa;
	@Column(name = Columns.MERCHANTPR_COINDKICD)
	private String coIndKiCd;
	@Column(name = Columns.MERCHANTPR_CONA)
	private String coNa;
	@Column(name = Columns.MERCHANTPR_CORUTYCA)
	private String coRuTyCa;
	@Column(name = Columns.MERCHANTPR_CORUTYCD)
	private String coRuTyCd;
	@Column(name = Columns.MERCHANTPR_COMPLAINTRATE)
	private String complaintRate;
	@Column(name = Columns.MERCHANTPR_COVERAGEAREA)
	private String coverageArea;
	@Column(name = Columns.MERCHANTPR_CULTURECYCLE)
	private String cultureCycle;
	@Column(name = Columns.MERCHANTPR_EQUIPMENTRATIO)
	private String equipmentRatio;
	@Column(name = Columns.MERCHANTPR_ESTYEARS)
	private String estYears;
	@Column(name = Columns.MERCHANTPR_EXTNU)
	private String extNu;
	@Column(name = Columns.MERCHANTPR_GGNA)
	private String ggNa;
	@Column(name = Columns.MERCHANTPR_GROWTHRATE)
	private String growthRate;
	@Column(name = Columns.MERCHANTPR_HOSTNU)
	private String hostNu;
	@Column(name = Columns.MERCHANTPR_LEGALPANO)
	private String legalPaNo;
	@Column(name = Columns.MERCHANTPR_LEGALPENA)
	private String legalPeNa;
	@Column(name = Columns.MERCHANTPR_OPERPASSRATE)
	private String operPassRate;
	@Column(name = Columns.MERCHANTPR_PERSONRATIO)
	private String personRatio;
	@Column(name = Columns.MERCHANTPR_PROPORTION)
	private String proportion;
	@Column(name = Columns.MERCHANTPR_PROVINCE)
	private String province;
	@Column(name = Columns.MERCHANTPR_QUALRATE)
	private String qualRate;
	@Column(name = Columns.MERCHANTPR_REGISTERCAPIAL)
	private String registerCapial;
	@Column(name = Columns.MERCHANTPR_RETRAINRATE)
	private String retrainRate;
	@Column(name = Columns.MERCHANTPR_RETURNRATE)
	private String returnRate;
	@Column(name = Columns.MERCHANTPR_SHAREHOLDERNA)
	private String shareholderNa;
	@Column(name = Columns.MERCHANTPR_SHAREHOLDERPANO)
	private String shareholderPaNo;
	@Column(name = Columns.MERCHANTPR_TEACHAREA)
	private String teachArea;
	@Column(name = Columns.MERCHANTPR_TEACHGROUNDENVIR)
	private String teachGroundEnvir;
	@Column(name = Columns.MERCHANTPR_TEACHGROUNDNATURE)
	private String teachGroundNature;
	@Column(name = Columns.MERCHANTPR_TESTPASSRATE)
	private String testPassRate;
	@Column(name = Columns.MERCHANTPR_TRAININCOME)
	private String trainIncome;
	@Column(name = Columns.MERCHANTPR_TRAINNUM)
	private String trainNum;
	@Column(name = Columns.MERCHANTPR_TRAINTIMES)
	private String trainTimes;
	@Column(name = Columns.MERCHANTPR_WORKYEARS)
	 ...
	 * @param coAssId
	 */
	public void setCoAssId(Long coAssId) {
