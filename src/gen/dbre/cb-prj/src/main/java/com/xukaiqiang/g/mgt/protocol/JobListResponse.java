...
public class JobListResponse extends OutputMessage implements Serializable {
	...
	public static <E> JobListResponse buildListResponse(JobListResponse pageResponse, List<E> list) {
		for(E e : list) {
