...
function getMyToDoTaskPage(path, pageNumber,pageSize,filter){
	...
	$.ajax({
		...
		dataType : 'json',
		cache: false,
		url: path+'/bpm/todotask/page/'+pageNumber,
...
function getMyDoneTaskPage(path, pageNumber,pageSize,filter){
	...
	$.ajax({
		...
		dataType : 'json',
		cache: false,
		url: path+'/bpm/donetask/page/'+pageNumber,
		data: {pageSize:pageSize,filter:filter},
		success: function(data, textStatus, jqXHR) {
			return data;
		},
...
function getMyFinishedTaskPage(path, pageNumber,pageSize,filter){
	...
	$.ajax({
		...
		dataType : 'json',
		cache: false,
		url: path+'/bpm/finishedtask/page/'+pageNumber,
		data: {pageSize:pageSize,filter:filter},
		success: function(data, textStatus, jqXHR) {
			return data;
		},
...
function getMyCanceledTaskPage(path, pageNumber,pageSize,filter){
	...
	$.ajax({
		...
		dataType : 'json',
		cache: false,
		url: path+'/bpm/canceledtask/page/'+pageNumber,
		data: {pageSize:pageSize,filter:filter},
		success: function(data, textStatus, jqXHR) {
			return data;
		},
