...
$(function () {
	...
	$('#previousPage').click(function () {
		window.location.href="/cb/loan-review/check-loan-information.html?taskId="+app.request.taskId;
	});
	/*下一步*/
    $(document).on("click", "#nextPage", function () {
		location.href="/cb/loan-review/check-approval-information.html?taskId="+app.request.taskId;
    });
});
