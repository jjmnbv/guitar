+ function ($, app) {
  ...
  $.extend(app, {
    ...
    //保存流程f
    FLOW_SAVE: app.base + '/bpm/flow/save',
    //根据状态获取流程列表
    ...
    //流程名称重复校验
    FLOW_NAMEVERIFY: app.base + '/bpm/flowinfo/samenameverify/',
    //停用流程
    ...
    //版本历史
    FLOW_SVN: app.base + '/bpm/flowversion',
    //流程办理-流程信息初始化
    FLOWPROCESS_INIT: app.base + '/bpm/flowprocess/flowinfoinit/',
  });
