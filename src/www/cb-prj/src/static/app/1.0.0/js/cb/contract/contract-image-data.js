...
$(function () {
    ...
    +function($, app) {
        ...
        $(document).on('click','#nextPage',function(){
			window.location.href="/cb/contract/contract-approval-information.html?taskId="+app.request.taskId;
        });
        /*上一步*/
        $('#previousPage').click(function () {
            window.location.href="/cb/contract/contract-signing.html?taskId="+app.request.taskId;
        });
