...
$(function () {
	...
	$('#previousPage').click(function () {
		window.location.href="/cb/superior-telephone-return/superior-applicant-information.html?taskId="+app.request.taskId;
	});
	/*下一步*/
    $(document).on("click", "#nextPage", function () {
		location.href="/cb/superior-telephone-return/superior-risk-warning.html?taskId="+app.request.taskId;
    });
});
