    ...
    +function ($,app) {
        ...
        var init = function () {
			...
			$.Bpm.initBusFormExt(function(formId, busId) {
				if (formId == 'information-submit-form') {
					$.getJSON(app.SUPERIOR_APPLICANT_INFORMATION+busId, function(res){
						if (app.isOK(res)) {
							App.stopPageLoading();
		...
		$(document).on("click", "#previousPage", function () {
			window.location.href="/cb/superior-telephone-return/superior-loan-information.html?taskId="+app.request.taskId;
		});
