(function (b) {
    var a = {};
    a.config = {
        editable: true, lineHeight: 15, basePath: "",
        rect: {
            attr: { x: 10, y: 10, width: 100, height: 50, r: 5, fill: "90-#fff-#C0C0C0", stroke: "#000", "stroke-width": 1 },
            showType: "image&text", type: "state", name: { text: "state", "font-style": "italic" }, text: { text: "状态", "font-size": 13 }, margin: 5, props: [], img: {}
        }, path: {
            attr: {
            ...
            pointer: {},
            path: {},
            states: { onclick: function (c) {console.log(arguments) }},
            save: {
                onclick: function (c) {
                    alert('default:\n'+c)
                }
    ...
    a.reload = function(x, r) {
        var y = a.config['_canvas'];
        a._init(x, r, y);
    };
    a.init = function (x, r) {
        var y = Raphael(x, v * 1.5, e * 1.5);
        a.config['_canvas'] = y;
        a._init(x, r, y);
    };
    a._init = function(x, r, y) {
        var v = b(window).width(), e = b(window).height(), q = {}, g = {};
        ...
        b(document).click(function () {alert(11)
