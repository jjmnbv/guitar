...
$(function () {
    ...
    $('.dataTables_scrollBody').delegate('tr', "click", function () {
        ...
        app.$getJSON(app.AFTERLOANWARNING_VIEW+"?varId="+id).done(function (data) {
...
function allBlacklist() {
    allBlacklistTable = $('#allBlacklistTable').DataTable({
        ...
        "drawCallback": function( settings ) {
            ...
            adjustTableHeight();
            if(api.rows({page:'current'}).data().length){
        ...
        "columns": [
            ...
            { data: "loanName"},
            {orderable:false,  data: "enityNo"},
            { data: "idType"},
            {orderable:false,  data: "age"}
        ]
    });
}