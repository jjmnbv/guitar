...
$(function () {
  ...
  //刷新
    $('#refresh').on('click',function () {
       selectedRowId = allBlacklistTable.rows('.active').data()[0].key;
       allBlacklistTable.draw();
    });
  ...
  //导出
    $('#export-excel').on('click',function () {
        ...
        $('#dynamicQueryBox').attr("action",app.PRELOANWARNING_EXPORT2);
        ...
        "columns": [
            {
                ...
                render: function (data, type, row, meta) {
                    ...
                    return '<span class="dataId" data-rowId="'+data.key+'" data-id="'+varId+'">'+varId+'</span>'
                }
            },
