+ function ($, app) {
  ...
  $.extend(app, {
    ...
    FLOWENGINE_STARTPROCESS_EXT: app.base + '/flowengine/start/{flowKey}.json',
    FLOWENGINE_HANDLE_EXT: app.base + '/flowengine/handleext/{taskId}.json',
    FLOWENGINE_HANDLE_EXTER: app.base + '/flowengine/handleexter/{taskId}.json',
    FLOWENGINE_HANDLE_DATA: app.base + '/flowengine/handledata/{taskId}.json'
  });
