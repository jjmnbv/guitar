...
function startProcess(path,flowId,flowKey){
	$.ajax({
		...
		dataType : 'json',
		url:  path + '/workflow/start/' + flowId,
...
function getMyToDoTaskPage(path, pageNumber,pageSize,filter){
	...
	$.ajax({
		...
		dataType : 'json',
		cache: false,
		url: path+'/workflow/todotask/page/'+pageNumber,
...
function getMyDoneTaskPage(path, pageNumber,pageSize,filter){
	...
	$.ajax({
		...
		dataType : 'json',
		cache: false,
		url: path+'/workflow/donetask/page/'+pageNumber,
		data: {pageSize:pageSize,filter:filter},
		success: function(data, textStatus, jqXHR) {
			return data;
		},
...
function getMyFinishedTaskPage(path, pageNumber,pageSize,filter){
	...
	$.ajax({
		...
		dataType : 'json',
		cache: false,
		url: path+'/workflow/finishedtask/page/'+pageNumber,
		data: {pageSize:pageSize,filter:filter},
		success: function(data, textStatus, jqXHR) {
			return data;
		},
...
function getMyCanceledTaskPage(path, pageNumber,pageSize,filter){
	...
	$.ajax({
		...
		dataType : 'json',
		cache: false,
		url: path+'/workflow/canceledtask/page/'+pageNumber,
		data: {pageSize:pageSize,filter:filter},
		success: function(data, textStatus, jqXHR) {
			return data;
		},
...
function cancelTask(path, taskId){
	...
	$.ajax({
		...
		dataType : 'json',
		cache: false,
		url: path+'/workflow/cancel/'+taskId,
		success: function(data, textStatus, jqXHR) {
			return data;
		},
		error: function(jqXHR, textStatus, errorThrown) {
...
function activeTask(path, taskId){
	...
	$.ajax({
		...
		dataType : 'json',
		cache: false,
		url: path+'/workflow/active/'+taskId,
		success: function(data, textStatus, jqXHR) {
			return data;
		},
		error: function(jqXHR, textStatus, errorThrown) {
...
function rollbackTask(path,taskId,comment){
	$.ajax({
		...
		dataType : 'json',
		cache: false,
		url: path+'/workflow/rollback/'+taskId,
