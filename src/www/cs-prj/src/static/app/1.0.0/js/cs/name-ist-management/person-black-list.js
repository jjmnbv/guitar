+ function($, app) {
  ...
  $('#join').getModal({
    ...
    app.context.submit({
      modal: modal,
      url: app.PERSON_BLACK_JOIN + '?blKeCd=' + $('[type=radio]:checked').data('id') + '&' + 'blVaCa=' + $('[type=radio]:checked').data('shu'),
      text: '转入成功',
      isEasyModal: true
    }, app);
  });
  ...
  $('#remove').getModal({
    ...
    app.context.submit({
      modal: modal,
      url: app.PERSON_BLACK_REMOVE + '?blKeCd=' + $('[type=radio]:checked').data('id') + '&' + 'blVaCa=' + $('[type=radio]:checked').data('shu'),
      text: '移出成功',
      isEasyModal: true
    }, app);
  });
