...
gulp.task('bs', function() {
    ...
    gulp.watch(['./build/**/*.html', './mock/**', './src/script/**']).on('change', bs.reload);
});
...
gulp.task('build', function () {
    gulp.src('src/views/pages/**/*.html')
            .pipe(handlebars(
                    ...
                    {
                        ignorePartials: true,
                        batch: ['../pub/views/partials', './src/views/partials'],
                        helpers: {
...
+ function (prjname, deproot, profile) {
    var
            ...
            steps = [
                 ...
                 */
                function () {
                    return gulp.src(['../pub/**', '!../pub/views{,/**}']).pipe(gulp.dest(path.resolve(prjdist, 'wwwroot')));
                },
                /**
                 * 拷贝模拟数据
                 */
