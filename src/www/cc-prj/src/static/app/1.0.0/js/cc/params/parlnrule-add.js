 ...
 var validatorNotExists = function (addForm) {
   ...
   $('[name=calCmIntInd]').on('change',function(){
	   ...
	   if(calValue =='Y'){
		   ...
		   $(".cmIntCalTyp  option[value='IP']").remove();
		   $(".cmIntCalTyp  option[value='P']").remove();
	   }else if(calValue =='N'){
		   $('.from-cmincaltype').hide();
		   $(".cmIntCalTyp").removeClass("required");
	   }
   });
    $("[name='ovIntCalTyp'] option[value='AI']").remove();
    $("[name='ovIntCalTyp'] option[value='FI']").remove();
    $("[name='ovIntCalTyp'] option[value='I']").remove();
