...
public class FindCuUsSByPostNoResponse extends OutputMessage implements Serializable {
	private static final long serialVersionUID = 1L;

	/**
	 * @see com.xukaiqiang.gu.mgt.protocol.FindCuUsSByPostNoResponse#getContent
	 */
	@JsonInclude(Include.NON_NULL)
