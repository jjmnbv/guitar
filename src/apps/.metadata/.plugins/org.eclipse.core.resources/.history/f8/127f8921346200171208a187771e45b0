...
<c:set target="${self}" property="title">已结任务</c:set>
...
<c:set target="${self.content}" property="paginationContainer">
  <div class="portlet-title">
    <div class="caption">
      <span><i class="fa fa-list"></i> 已结任务列表 </span>
    </div>
    <div class="actions">
  ...
  <div class="portlet-body pagination-container" data-page-first-store="first-store" data-page-url="${base}/workflow/finishedtask/page" data-page-template-id="flows-page-template"></div>
</c:set>
