...
import com.xukaiqiang.g.mgt.protocol.RoleCreateRequest;
import com.xukaiqiang.g.mgt.protocol.RoleListResponse;
import com.xukaiqiang.g.mgt.protocol.RolePageResponse;
import com.xukaiqiang.g.mgt.protocol.RoleResponse;
import com.xukaiqiang.g.mgt.protocol.RoleUpdateRequest;
