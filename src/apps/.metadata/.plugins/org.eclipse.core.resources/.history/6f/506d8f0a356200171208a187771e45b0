...
import com.xukaiqiang.g.mgt.protocol.WorksCreateRequest;
import com.xukaiqiang.g.mgt.protocol.WorksListResponse;
import com.xukaiqiang.g.mgt.protocol.WorksPageResponse;
import com.xukaiqiang.g.mgt.protocol.WorksResponse;
import com.xukaiqiang.g.mgt.protocol.WorksUpdateRequest;
import com.xukaiqiang.g.mgt.service.WorksService;
import com.xukaiqiang.g.mgt.util.Urls;
import com.xukaiqiang.g.mgt.util.Views;
import com.xukaiqiang.g.orm.entity.Works;
import com.xukaiqiang.g.orm.protocol.WorksFilterRequest;
