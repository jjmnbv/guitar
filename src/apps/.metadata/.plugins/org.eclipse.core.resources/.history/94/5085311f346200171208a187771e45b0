...
<c:set target="${self}" property="title">系统岗位-岗位对象设置</c:set>
...
<c:set target="${self.js}" property="main">
  <!-- <script src=""></script> -->
  <script src="${self.path.app}/js/admin/position-target.js"></script>
  <script>
    $(function () {
...
<c:set target="${self.content}" property="breadcrumb">
  <div class="page-title">
    <h1><small>系统管理 &gt; <a href="${base}/position/index">系统岗位管理</a> &gt; 岗位对象设置</small></h1>
  </div>
</c:set>

<c:set target="${self.content}" property="main">
  <form id="position-target" action="${base}/position/users-update" method="POST">
    <div class="portlet box blue">
      <div class="portlet-title">
        <div class="caption"><i class="fa fa-cogs"></i>系统岗位-岗位对象设置</div>
        <div class="tools">
            ...
            <div class="col-md-offset-4 col-md-4">
              <div class="form-group">
                <div class="input-group">
                  ...
                  <input type="text" name="name" value="${position.name}" class="form-control input-sm" readonly="readonly" required>
                </div>
              </div>
              <div class="form-group">
                <div class="input-group">
                  <span class="input-group-addon">描述</span>
                  <input type="text" name="description" value="${position.description}" class="form-control input-sm" readonly="readonly" required>
                </div>
              </div>
              <div class="form-group">
                <div class="input-group">
