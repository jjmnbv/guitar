...
import com.xukaiqiang.g.mgt.protocol.UserCreateRequest;
import com.xukaiqiang.g.mgt.protocol.UserListResponse;
import com.xukaiqiang.g.mgt.protocol.UserPageResponse;
import com.xukaiqiang.g.mgt.protocol.UserResponse;
import com.xukaiqiang.g.mgt.protocol.UserUpdateRequest;
import com.xukaiqiang.g.mgt.service.UserService;
import com.xukaiqiang.g.mgt.util.Urls;
import com.xukaiqiang.g.mgt.util.Views;
import com.xukaiqiang.g.orm.entity.User;
import com.xukaiqiang.g.orm.protocol.UserFilterRequest;
