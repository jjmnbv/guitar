...
public class ConListResponse extends OutputMessage implements Serializable {
	...
	public static <E> ConListResponse buildListResponse(ConListResponse pageResponse, List<E> list) {
		for(E e : list) {
