...
/*详情录入人修改：*/
app.pathArray=[ 
      {"code":"nextData","flag": <spring:eval expression="@FN_CB.checkPath('/cb/loandetailapply/updatePeople')" />},
      {"code":"tempData","flag": <spring:eval expression="@FN_CB.checkPath('/cb/loandetailapply/cachePeople')" />},
      {"code":"saveData","flag": <spring:eval expression="@FN_CB.checkPath('/cb/loandetailapply/updatePeople')" />},
      {"code":"historical","flag": <spring:eval expression="@FN_CB.checkPath('/cb/loanapply/loanapplyHistoryForDetailList/')" />}
    ];
	...
	app.addressTypeCodeList=app.dicts.dict_147; /*地址类型代码*/
