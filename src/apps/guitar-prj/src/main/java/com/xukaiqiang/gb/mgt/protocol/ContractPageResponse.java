...
public class ContractPageResponse extends PageResponse implements Serializable {
	...
	public static <E> ContractPageResponse buildPageResponse(ContractPageResponse pageResponse, Page<E> page, int displayPages) {
