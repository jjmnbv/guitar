...
public class StorePageResponse extends PageResponse implements Serializable {
	...
	public static <E> StorePageResponse buildPageResponse(StorePageResponse pageResponse, Page<E> page, int displayPages) {
