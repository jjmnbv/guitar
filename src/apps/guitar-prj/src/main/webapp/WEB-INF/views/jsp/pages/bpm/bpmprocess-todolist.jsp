...
<c:set target="${self}" property="title">待办任务</c:set>
...
<c:set target="${self.js}" property="main">
  <script src="${self.path.app}/js/bpm/flowprocess-todolist.js"></script>
  <script>
  	$(function () {
...
<c:set target="${self.content}" property="paginationContainer">
  <div class="portlet-title">
    <div class="caption">
      <span><i class="fa fa-list"></i> 待办任务列表 </span>
    </div>
    <div class="actions">
  ...
  <div class="portlet-body pagination-container" data-page-first-store="first-store" data-page-url="${base}/workflow/todotask/page" data-page-template-id="flows-page-template"></div>
</c:set>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td> {{description}} </td>
						<th> {{createTime}} </th>
						<td>
				 			<a href="javascript:;" class="flow-todo" data-deployid="{{deployId}}" data-id="{{taskId}}" data-flowKey="{{flowKey}}" data-stepKey="{{stepKey}}">办理</a> 
						</td>
          </tr>
          {{/each}}
        </tbody>
