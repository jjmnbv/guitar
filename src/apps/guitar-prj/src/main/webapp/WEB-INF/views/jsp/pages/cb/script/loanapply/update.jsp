...
+function($, app) {
app.pathArray=[
      {"code":"updateData" ,"flag":<spring:eval expression="@FN_CB.checkPath('/cb/loanapply/update')" /> },
      {"code":"submitData","flag": <spring:eval expression="@FN_CB.checkPath('/cb/loanapply/update')" />}
    ];
