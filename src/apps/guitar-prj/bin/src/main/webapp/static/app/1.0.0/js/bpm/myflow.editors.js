...
$.extend(true, myflow.editors, {
	inputEditor3 : function(){
		...
		this.init = function(props, k, div, src, r){
			...
			$('<textarea style="width:100%;outline-color:red;border:1px solid red" readonly="readonly"></textarea>').val(props[_k].value).change(function(){
	...
	inputEditor2 : function(){
		...
		this.init = function(props, k, div, src, r){
			...
			$('<textarea style="width:100%;outline-color:red;border:1px solid red"></textarea>').val(props[_k].value).change(function(){
				props[_k].value = $(this).val();
			}).appendTo('#'+_div);
	...
	inputEditor : function(){
		...
		this.init = function(props, k, div, src, r){
			...
			$('<textarea style="width:100%;"></textarea>').val(props[_k].value).change(function(){
				props[_k].value = $(this).val();
			}).appendTo('#'+_div);
