...
public class CuBrSListResponse extends OutputMessage implements Serializable {
	...
	public static <E> CuBrSListResponse buildListResponse(
			CuBrSListResponse pageResponse, List<E> list) {
		for (E e : list) {
