...
public class CuRoSListResponse extends OutputMessage implements Serializable {
	...
	public static <E> CuRoSListResponse buildListResponse(
			CuRoSListResponse pageResponse, List<E> list) {
		for (E e : list) {
