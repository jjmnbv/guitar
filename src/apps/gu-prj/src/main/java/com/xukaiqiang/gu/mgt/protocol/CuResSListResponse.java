...
public class CuResSListResponse extends OutputMessage implements Serializable {
	...
	public static <E> CuResSListResponse buildListResponse(
			CuResSListResponse pageResponse, List<E> list) {
		for (E e : list) {
