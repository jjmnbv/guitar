...
public class CuUsChPwdLListResponse extends OutputMessage implements Serializable {
	...
	public static <E> CuUsChPwdLListResponse buildListResponse(CuUsChPwdLListResponse pageResponse, List<E> list) {
		for(E e : list) {
