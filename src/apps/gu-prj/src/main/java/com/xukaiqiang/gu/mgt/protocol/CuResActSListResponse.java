...
public class CuResActSListResponse extends OutputMessage implements Serializable {
	...
	public static <E> CuResActSListResponse buildListResponse(CuResActSListResponse pageResponse, List<E> list) {
		for(E e : list) {
