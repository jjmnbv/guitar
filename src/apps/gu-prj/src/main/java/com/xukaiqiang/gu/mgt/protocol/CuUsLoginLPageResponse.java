...
public class CuUsLoginLPageResponse extends PageResponse implements Serializable {
	...
	public static <E> CuUsLoginLPageResponse buildPageResponse(CuUsLoginLPageResponse pageResponse, Page<E> page, int displayPages) {
