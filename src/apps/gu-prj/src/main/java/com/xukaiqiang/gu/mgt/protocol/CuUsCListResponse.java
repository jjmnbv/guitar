...
public class CuUsCListResponse extends OutputMessage implements Serializable {
	...
	public static <E> CuUsCListResponse buildListResponse(CuUsCListResponse pageResponse, List<E> list) {
		for(E e : list) {
