...
public class CuUsPostSListResponse extends OutputMessage implements Serializable {
	...
	public static <E> CuUsPostSListResponse buildListResponse(CuUsPostSListResponse pageResponse, List<E> list) {
		for(E e : list) {
