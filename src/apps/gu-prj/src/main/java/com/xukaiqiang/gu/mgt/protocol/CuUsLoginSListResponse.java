...
public class CuUsLoginSListResponse extends OutputMessage implements Serializable {
	...
	public static <E> CuUsLoginSListResponse buildListResponse(CuUsLoginSListResponse pageResponse, List<E> list) {
		for(E e : list) {
