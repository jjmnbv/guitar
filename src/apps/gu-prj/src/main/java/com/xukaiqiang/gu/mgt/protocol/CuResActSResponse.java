...
public class CuResActSResponse extends OutputMessage implements Serializable {
	...
	public static <E> CuResActSResponse buildResponse(CuResActSResponse response, E e) {
