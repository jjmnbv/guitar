...
public class CuSyCListResponse extends OutputMessage implements Serializable {
	...
	public static <E> CuSyCListResponse buildListResponse(CuSyCListResponse pageResponse, List<E> list) {
		for(E e : list) {
