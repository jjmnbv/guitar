...
public class CuResSPageResponse extends PageResponse implements Serializable {
	...
	public static <E> CuResSPageResponse buildPageResponse(
			CuResSPageResponse pageResponse, Page<E> page, int displayPages) {
