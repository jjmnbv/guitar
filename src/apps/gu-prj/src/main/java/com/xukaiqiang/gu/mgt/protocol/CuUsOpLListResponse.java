...
public class CuUsOpLListResponse extends OutputMessage implements Serializable {
	...
	public static <E> CuUsOpLListResponse buildListResponse(CuUsOpLListResponse pageResponse, List<E> list) {
		for(E e : list) {
