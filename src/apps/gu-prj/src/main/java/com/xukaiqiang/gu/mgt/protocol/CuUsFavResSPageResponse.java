...
public class CuUsFavResSPageResponse extends PageResponse implements Serializable {
	...
	public static <E> CuUsFavResSPageResponse buildPageResponse(CuUsFavResSPageResponse pageResponse, Page<E> page, int displayPages) {
