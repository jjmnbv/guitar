...
public class CuPostSPageResponse extends PageResponse implements Serializable {
	...
	public static <E> CuPostSPageResponse buildPageResponse(CuPostSPageResponse pageResponse, Page<E> page, int displayPages) {
