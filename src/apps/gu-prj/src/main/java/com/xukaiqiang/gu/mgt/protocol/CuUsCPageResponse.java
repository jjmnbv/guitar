...
public class CuUsCPageResponse extends PageResponse implements Serializable {
	...
	public static <E> CuUsCPageResponse buildPageResponse(CuUsCPageResponse pageResponse, Page<E> page, int displayPages) {
