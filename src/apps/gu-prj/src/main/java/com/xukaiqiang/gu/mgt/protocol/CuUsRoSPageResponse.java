...
public class CuUsRoSPageResponse extends PageResponse implements Serializable {
	...
	public static <E> CuUsRoSPageResponse buildPageResponse(CuUsRoSPageResponse pageResponse, Page<E> page, int displayPages) {
