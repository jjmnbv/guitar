...
public class CuIconSListResponse extends OutputMessage implements Serializable {
	...
	public static <E> CuIconSListResponse buildListResponse(CuIconSListResponse pageResponse, List<E> list) {
		for(E e : list) {
