...
public class CuUsLoginLListResponse extends OutputMessage implements Serializable {
	...
	public static <E> CuUsLoginLListResponse buildListResponse(CuUsLoginLListResponse pageResponse, List<E> list) {
		for(E e : list) {
