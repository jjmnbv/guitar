...
public class CuSyOpLPageResponse extends PageResponse implements Serializable {
	...
	public static <E> CuSyOpLPageResponse buildPageResponse(CuSyOpLPageResponse pageResponse, Page<E> page, int displayPages) {
