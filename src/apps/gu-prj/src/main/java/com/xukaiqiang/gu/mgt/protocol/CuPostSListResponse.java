...
public class CuPostSListResponse extends OutputMessage implements Serializable {
	...
	public static <E> CuPostSListResponse buildListResponse(CuPostSListResponse pageResponse, List<E> list) {
		for(E e : list) {
