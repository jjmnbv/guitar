...
public class CuUsLoginSPageResponse extends PageResponse implements Serializable {
	...
	public static <E> CuUsLoginSPageResponse buildPageResponse(CuUsLoginSPageResponse pageResponse, Page<E> page, int displayPages) {
