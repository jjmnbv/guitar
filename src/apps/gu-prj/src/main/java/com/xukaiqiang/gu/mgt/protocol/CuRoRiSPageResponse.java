...
public class CuRoRiSPageResponse extends PageResponse implements Serializable {
	...
	public static <E> CuRoRiSPageResponse buildPageResponse(CuRoRiSPageResponse pageResponse, Page<E> page, int displayPages) {
