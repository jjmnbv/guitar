...
public class CuUsHolLPageResponse extends PageResponse implements Serializable {
	...
	public static <E> CuUsHolLPageResponse buildPageResponse(
			CuUsHolLPageResponse pageResponse, Page<E> page, int displayPages) {
