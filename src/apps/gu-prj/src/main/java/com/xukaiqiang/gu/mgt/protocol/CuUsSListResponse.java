...
public class CuUsSListResponse extends OutputMessage implements Serializable {
	...
	public static <E> CuUsSListResponse buildListResponse(
			CuUsSListResponse pageResponse, List<E> list) {
		for (E e : list) {
